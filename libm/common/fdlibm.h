...
#define SAFE_LEFT_SHIFT(op, amt)  (((amt) < (int)(8 * sizeof(op))) ? ((op) << (amt)) : 0)

#define SAFE_RIGHT_SHIFT(op, amt) (((amt) < (int)(8 * sizeof(op))) ? ((op) >> (amt)) : 0)
 ...
 */
#define lsl(__x, __s)                                                                       \
    ((sizeof(__x) == sizeof(char))        ? (__typeof(__x))((unsigned char)(__x) << (__s))  \
         : (sizeof(__x) == sizeof(short)) ? (__typeof(__x))((unsigned short)(__x) << (__s)) \
         : (sizeof(__x) == sizeof(int))   ? (__typeof(__x))((unsigned int)(__x) << (__s))   \
         : (sizeof(__x) == sizeof(long))  ? (__typeof(__x))((unsigned long)(__x) << (__s))  \
