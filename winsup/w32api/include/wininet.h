...
#define GOPHER_INFO_CATEGORY _TEXT("+INFO")
#define GOPHER_ADMIN_CATEGORY _TEXT("+ADMIN")
#define GOPHER_VIEWS_CATEGORY _TEXT("+VIEWS")
#define GOPHER_ABSTRACT_CATEGORY _TEXT("+ABSTRACT")
#define GOPHER_VERONICA_CATEGORY _TEXT("+VERONICA")
#define GOPHER_ADMIN_ATTRIBUTE _TEXT("Admin")
#define GOPHER_MOD_DATE_ATTRIBUTE _TEXT("Mod-Date")
#define GOPHER_TTL_ATTRIBUTE _TEXT("TTL")
#define GOPHER_SCORE_ATTRIBUTE _TEXT("Score")
#define GOPHER_RANGE_ATTRIBUTE _TEXT("Score-range")
#define GOPHER_SITE_ATTRIBUTE _TEXT("Site")
#define GOPHER_ORG_ATTRIBUTE _TEXT("Org")
#define GOPHER_LOCATION_ATTRIBUTE _TEXT("Loc")
#define GOPHER_GEOG_ATTRIBUTE _TEXT("Geog")
#define GOPHER_TIMEZONE_ATTRIBUTE _TEXT("TZ")
#define GOPHER_PROVIDER_ATTRIBUTE _TEXT("Provider")
#define GOPHER_VERSION_ATTRIBUTE _TEXT("Version")
#define GOPHER_ABSTRACT_ATTRIBUTE _TEXT("Abstract")
#define GOPHER_VIEW_ATTRIBUTE _TEXT("View")
#define GOPHER_TREEWALK_ATTRIBUTE _TEXT("treewalk")
...
#define HTTP_VERSION _TEXT("HTTP/1.0")
