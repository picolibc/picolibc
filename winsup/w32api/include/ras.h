...
#define RASDT_Modem                     _TEXT("modem")
#define RASDT_Isdn                      _TEXT("isdn")
#define RASDT_X25                       _TEXT("x25")
#define RASDT_Vpn                       _TEXT("vpn")
#define RASDT_Pad                       _TEXT("pad")
#define RASDT_Generic                   _TEXT("GENERIC")
#define RASDT_Serial        		_TEXT("SERIAL")
#define RASDT_FrameRelay                _TEXT("FRAMERELAY")
#define RASDT_Atm                       _TEXT("ATM")
#define RASDT_Sonet                     _TEXT("SONET")
#define RASDT_SW56                      _TEXT("SW56")
#define RASDT_Irda                      _TEXT("IRDA")
#define RASDT_Parallel                  _TEXT("PARALLEL")
